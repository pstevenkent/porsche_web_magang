        ...
        <div className="w-full lg:w-1/3 p-6">
            <div className="sticky top-20">
                ...
                <div className="border-b border-porscheGray pb-4 my-4">
                    ...
                    <p className="text-2xl font-bold text-porscheBlack">{new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0 }).format(Math.round(car?.price || 0))}</p>
                </div>
